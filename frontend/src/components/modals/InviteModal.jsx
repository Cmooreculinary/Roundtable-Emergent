          ...
          {!code ? (
            ...
            <div style={{ background: "var(--bg-tertiary)", borderRadius: 12, padding: 16 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 12 }}>
                <a className="btn btn-secondary" href={`sms:?body=Join my Round Table with code ${code}`} data-testid="invite-sms"><MessageSquare size={13} /> SMS</a>
                <a className="btn btn-secondary" href={`mailto:?subject=Come to my Round Table&body=Join with code: ${code}`} data-testid="invite-email"><Mail size={13} /> Email</a>
              </div>
            </div>
          )}
        </div>
